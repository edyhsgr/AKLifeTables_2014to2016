...
#####
##**Below is modified to work for single year rather than abridged - EddieH, Feb 2018**
#####
...
DeathsAndPopulation<-read.table(file="https://raw.githubusercontent.com/edyhsgr/AKLifeTables_2014to2016/master/DeathsAndPopulation_AK2014to2016InputsSingleYear.csv",header=TRUE,sep=",")
DeathsAndPopulation
